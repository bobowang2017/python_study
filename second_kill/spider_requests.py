...
from second_kill.utils import save_image, open_image, add_bg_for_qr, parse_json, wait_some_time


class SpiderSession(object):
    def __init__(self):
        self.cookies_dir_path = "cookies/"
        self.user_agent = global_config.get_raw('config', 'default_user_agent')
...
class JdSecondKill(object):
    def __init__(self):
        ...
        # 初始化信息
        self.sku_id = global_config.get_raw('config', 'sku_id')
        self.second_kill_num = 2
